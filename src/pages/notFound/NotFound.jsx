            ...
            <section>
                <div className={styles.notFoundOuterContainer}>
                    <div className={styles.notFoundInnerContainer}>
                        <div>
                            <h1 className={styles.title}><span className={styles.title404}>404|</span>Pagina niet
                                gevonden</h1>
                        </div>
                        <div>
                            <p className={styles.text}>De pagina die je zoekt bestaat niet. Je wordt binnen 3 seconden
